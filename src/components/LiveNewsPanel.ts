...
export const OPTIONAL_LIVE_CHANNELS: LiveChannel[] = [
  ...
  { id: 'livenow-fox', name: 'LiveNOW from FOX', handle: '@LiveNOWFOX', fallbackVideoId: 'kB4Q2rN6yTs' },
  { id: 'abc-news', name: 'ABC News', handle: '@ABCNews', fallbackVideoId: 'U3g3sM4_9Y0' },
  ...
  { id: 'rt', name: 'RT', handle: '', fallbackVideoId: 'V7B4lA2mN9Q' },
  ...
  { id: 'record-news', name: 'Record News', handle: '@RecordNews', fallbackVideoId: 'pD6xR8tV1mA' },
  ...
  { id: 'wion', name: 'WION', handle: '@WION', fallbackVideoId: 'J8nV2qL4sXc' },
  ...
  { id: 'arirang-news', name: 'Arirang News', handle: '@ArirangCoKrArirangNEWS', fallbackVideoId: 'M2n4B6v8C0x' },
  { id: 'india-today', name: 'India Today', handle: '@indiatoday', fallbackVideoId: 'sYZtOFzM78M' },
  { id: 'abp-news', name: 'ABP News', handle: '@ABPNews', fallbackVideoId: 'L9p2R4t6Y8u' },
  ...
  { id: 'rudaw', name: 'Rudaw', hlsUrl: 'https://svs.itworkscdn.net/rudawlive/rudawlive.smil/playlist.m3u8', fallbackVideoId: 'nR5mT3pQ8vL', useFallbackOnly: true },
  // Africa
  ...
  { id: 'sabc-news', name: 'SABC News', handle: '@SABCDigitalNews', fallbackVideoId: 'D7f5G3h1J9k' },
  ...
  { id: 'tv5monde-info', name: 'TV5 Monde Info', handle: '@TV5MONDEInfo', fallbackVideoId: 'Q1w2E3r4T5y' },
  { id: 'nrk1', name: 'NRK1', handle: '@nrk', fallbackVideoId: 'R4t6Y8u1I3o' },
  { id: 'aljazeera-balkans', name: 'Al Jazeera Balkans', handle: '@AlJazeeraBalkans', fallbackVideoId: 'H5j7K9l2Z4x' },
  // Oceania
...
const _REGION_ENTRIES: { key: string; labelKey: string; channelIds: string[] }[] = [
  { key: 'na', labelKey: 'components.liveNews.regionNorthAmerica', channelIds: ['bloomberg', 'cnbc', 'yahoo', 'cnn', 'fox-news', 'newsmax', 'livenow-fox', 'abc-news', 'cbs-news', 'nbc-news', 'cbc-news', 'nasa'] },
