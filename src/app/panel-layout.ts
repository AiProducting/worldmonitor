...
export class PanelLayoutManager implements AppModule {
  ...
  private createPanels(): void {
    ...
    this.lazyPanel('bond-yields-global', () =>
      import('@/components/BondYieldsGlobalPanel').then(m => new m.BondYieldsGlobalPanel()),
    );

    this.lazyPanel('volatility-dashboard', () =>
    ...
    this.lazyPanel('fear-greed', () =>
      import('@/components/FearGreedIndexPanel').then(m => new m.FearGreedIndexPanel()),
    );

    this.lazyPanel('portfolio-correlation', () =>
      import('@/components/PortfolioCorrelationPanel').then(m => new m.PortfolioCorrelationPanel()),
    );

    this.lazyPanel('global-debt', () =>
      import('@/components/GlobalDebtMonitorPanel').then(m => new m.GlobalDebtMonitorPanel()),
    );

    this.lazyPanel('yield-curve-analysis', () =>
      import('@/components/YieldCurveAnalysisPanel').then(m => new m.YieldCurveAnalysisPanel()),
    );
    ...
    this.lazyPanel('currency-strength', () =>
      import('@/components/CurrencyStrengthPanel').then(m => new m.CurrencyStrengthPanel()),
    );

    this.lazyPanel('dividend-tracker', () =>
      import('@/components/DividendTrackerPanel').then(m => new m.DividendTrackerPanel()),
    );

    this.lazyPanel('ipo-pipeline', () =>
      import('@/components/IPOPipelinePanel').then(m => new m.IPOPipelinePanel()),
    );
