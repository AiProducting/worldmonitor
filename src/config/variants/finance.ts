...
export const DEFAULT_PANELS: Record<string, PanelConfig> = {
  ...
  'central-bank-rates': { name: 'Central Bank Rates', enabled: true, priority: 1 },
  'economic-indicators': { name: 'Economic Indicators', enabled: true, priority: 1 },
  'sector-performance': { name: 'Sector Performance', enabled: true, priority: 1 },
  'commodity-tracker': { name: 'Commodities', enabled: true, priority: 1 },
  'forex-dashboard': { name: 'Forex Dashboard', enabled: true, priority: 1 },
  'crypto-market': { name: 'Crypto Market', enabled: true, priority: 1 },
  'global-indices': { name: 'Global Indices', enabled: true, priority: 1 },
  'credit-risk': { name: 'Credit Risk (BIS)', enabled: true, priority: 1 },
  'real-exchange-rate': { name: 'Real Exchange Rates', enabled: true, priority: 1 },
  'energy-prices': { name: 'Energy Prices', enabled: true, priority: 1 },
  'macro-regime': { name: 'Macro Regime', enabled: true, priority: 1 },
  ...
  'fear-greed': { name: 'Fear & Greed Index', enabled: true, priority: 1 },
  'portfolio-correlation': { name: 'Cross-Asset Correlations', enabled: true, priority: 1 },
  'global-debt': { name: 'Global Debt Monitor', enabled: true, priority: 1 },
  'yield-curve-analysis': { name: 'Yield Curve Analysis', enabled: true, priority: 1 },
